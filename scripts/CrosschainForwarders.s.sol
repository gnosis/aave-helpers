...
import {CrosschainForwarderAMB} from '../src/crosschainforwarders/CrosschainForwarderAMB.sol';
...
contract DeployGnosis is EthereumScript {
  function run() external broadcast {
    new CrosschainForwarderAMB();
  }
}